...
public class RotateZoomTextView extends AppCompatEditText implements View.OnTouchListener{
    ...
    float scalediff;
    public RotateZoomTextView(Context context) {
        super(context);
        init(context);
    }

    public RotateZoomTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public RotateZoomTextView(Context context, AttributeSet attrs, int defStyle) {
